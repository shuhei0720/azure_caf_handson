...
## 11.2 Azure Policy の理解

### 11.2.1 Azure Policy とは
...
## 11.3 組み込み Policy の適用

### 11.3.1 重要な組み込み Policy
...
### 11.3.2 Management Group への Policy 適用
...
## 11.4 カスタム Policy の作成

### 11.4.1 命名規則を強制する Policy
...
## 11.5 Policy Initiative の作成

### 11.5.1 Policy Initiative とは

**Policy Initiative**（ポリシーセット）は、複数の Policy をグループ化したものです。

### 11.5.2 CAF Landing Zone Initiative
...
## 11.7 Policy Compliance 監視

### 11.7.1 コンプライアンス状態の確認
...
## 11.9 Cost Managementの設定

### 11.9.1 予算（Budget）の作成
...
```bash
git add .
git commit -m "Chapter 11: Governance and policy implementation
...
ガバナンス基盤が構築できたら、次は CI/CD パイプラインの構築に進みます。

👉 [第 12 章：CI/CD パイプライン構築](chapter12-cicd.md)
